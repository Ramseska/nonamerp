...
namespace server_side.Utilities
{
    class Colors
    {
        ...
        public const string BLACK = "!{aaaaaa}";
        public const string RED = "!{ffaaaa}";
        public const string GREEN = "!{aaffaa}";
        public const string BLUE = "!{aaaaff}";
        ...
        public const string CYAN = "!{aaffff}";
        public const string TEAL = "!{008080}";
        public const string NAVY = "!{000080}";
        public const string FUCHISA = "!{ff00ff}";
